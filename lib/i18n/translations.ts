    ...
    sponsorsSection: {
      ...
      sponsors: [
        ...
        },
        {
          ...
          name: "Maria Osipova",
          label: "Featured Sponsor",
          logo: "/images/sponsors/maria-osipova/maria-osipova-logo.webp",
          logoAlt: "Maria Osipova, photographer and videographer, logo",
          location: "Los Angeles",
          description:
            "Maria Osipova is a Los Angeles–based photographer and videographer specializing in fashion, lifestyle, and commercial content. She creates photo and video content for individuals, models and modeling agencies, fashion and beauty brands, e-commerce, and businesses, combining a cinematic visual style with a modern editorial approach.",
          website: "https://maria-osipova.kavyar.site",
...
const ru: typeof en = {
  ...
  home: {
    ...
    founder: {
      ...
      paragraphs: [
        "Иулия начала профессиональный путь как лэшмейкер и преподаватель. Позже она основала собственную школу и студию по наращиванию ресниц, стала победительницей профессиональных чемпионатов и судьёй конкурсов.",
        "Сегодня Иулия владеет консалтинговой компанией, которая помогает специалистам beauty-индустрии получать профессиональные лицензии в США, развивать карьеру, формировать сильное профессиональное портфолио и создавать личный бренд.",
      ],
      missionTitle: "Зачем существует Beauty Business Forum",
      missionText: "Опираясь на практический опыт специалиста, преподавателя и предпринимателя, Иулия создала Beauty Business Forum — платформу для роста, обмена знаниями, полезных деловых связей и профессионального признания в beauty-индустрии.",
      imageAlt: "Iuliia Andreeva, основатель и президент IBPA, на мероприятии Beauty Business Forum",
    ...
    sponsorsSection: {
      ...
      sponsors: [
        ...
        },
        {
          ...
          label: "Главный спонсор",
          logo: "/images/sponsors/maria-osipova/maria-osipova-logo.webp",
          logoAlt: "Логотип Maria Osipova, фотограф и видеограф",
          location: "Лос-Анджелес",
          description:
            "Maria Osipova — фотограф и видеограф из Лос-Анджелеса, специализируется на fashion-, lifestyle- и коммерческом контенте. Она создаёт фото- и видеоконтент для частных клиентов, моделей и модельных агентств, fashion- и beauty-брендов, e-commerce и бизнеса, сочетая кинематографичный визуальный стиль с современным editorial-подходом.",
          website: "https://maria-osipova.kavyar.site",
          websiteLabel: "maria-osipova.kavyar.site",
          instagram: "https://www.instagram.com/maria.osipova.visual/",
          instagramLabel: "@maria.osipova.visual",
...
const ua: typeof en = {
  ...
  home: {
    ...
    founder: {
      ...
      paragraphs: [
        "Iuliia розпочала професійний шлях як лешмейстерка та викладачка. Згодом вона заснувала власну школу та студію нарощування вій, стала переможницею професійних чемпіонатів і суддею конкурсів.",
        "Сьогодні Iuliia володіє консалтинговою компанією, яка допомагає фахівцям beauty-індустрії отримувати професійні ліцензії у США, розвивати кар’єру, формувати сильне професійне портфоліо та створювати особистий бренд.",
      ],
      missionTitle: "Навіщо існує Beauty Business Forum",
      missionText: "Поєднавши практичний досвід фахівчині, викладачки та підприємиці, Iuliia створила Beauty Business Forum — платформу для розвитку, обміну знаннями, змістовних ділових зв’язків і професійного визнання у beauty-індустрії.",
      imageAlt: "Iuliia Andreeva, засновниця та президентка IBPA, на заході Beauty Business Forum",
    ...
    sponsorsSection: {
      ...
      sponsors: [
        ...
        },
        {
          ...
          label: "Головний спонсор",
          logo: "/images/sponsors/maria-osipova/maria-osipova-logo.webp",
          logoAlt: "Логотип Maria Osipova, фотограф і відеограф",
          location: "Лос-Анджелес",
          description:
            "Maria Osipova — фотограф і відеограф із Лос-Анджелеса, спеціалізується на fashion-, lifestyle- та комерційному контенті. Вона створює фото- та відеоконтент для приватних клієнтів, моделей і модельних агентств, fashion- і beauty-брендів, e-commerce та бізнесу, поєднуючи кінематографічний візуальний стиль із сучасним editorial-підходом.",
          website: "https://maria-osipova.kavyar.site",
          websiteLabel: "maria-osipova.kavyar.site",
          instagram: "https://www.instagram.com/maria.osipova.visual/",
          instagramLabel: "@maria.osipova.visual",
