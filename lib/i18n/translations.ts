    ...
    sponsorsSection: {
      ...
      sponsors: [
        ...
        },
        {
          ...
          name: "NePOP Radio",
          label: "Featured Sponsor",
          logo: "/images/sponsors/nepop-radio/nepop-radio-logo.webp",
          logoAlt: "NePOP Radio logo",
          logoBadge: true,
          description:
            "NePOP Radio is not background noise — it's the sound of our reality. Music we grew up on. Music we live by. And unfiltered conversations about life, adaptation, and immigration in the United States — honest, sometimes raw, always to the point.",
