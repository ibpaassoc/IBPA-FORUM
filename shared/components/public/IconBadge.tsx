...
export default function IconBadge({ icon: Icon, size = 24, className }: IconBadgeProps) {
  return (
    <span
      className={clsx(
        "inline-flex items-center justify-center rounded-full border border-[var(--border-soft)] bg-[var(--surface-tint)] text-[var(--color-hover-accent)] transition-all duration-300",
