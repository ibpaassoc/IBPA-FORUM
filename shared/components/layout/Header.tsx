...
export default function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 w-full px-3 pt-3 sm:px-5">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[1.75rem] border border-[#d8c27a]/18 bg-[linear-gradient(135deg,rgba(19,20,22,0.96),rgba(17,18,20,0.94)_55%,rgba(15,16,18,0.96))] shadow-[0_18px_50px_rgba(0,0,0,0.28)] backdrop-blur-xl lg:overflow-visible">
