...
export default function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 w-full px-3 pt-3 sm:px-5">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[1.75rem] border border-[#d8c27a]/18 bg-[linear-gradient(135deg,rgba(25,24,26,0.94),rgba(18,22,28,0.9)_55%,rgba(39,33,24,0.86))] shadow-[0_18px_50px_rgba(0,0,0,0.28)] backdrop-blur-xl lg:overflow-visible">
