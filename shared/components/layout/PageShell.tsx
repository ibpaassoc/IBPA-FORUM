...
export function PageHero({
  ...
  return (
    ...
    >
      <div className="page-section relative z-10 grid gap-[var(--space-xl)] py-[var(--space-2xl)] lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div className="max-w-3xl">
          <p className="page-eyebrow">{eyebrow}</p>
          <h1 className="mt-[var(--space-md)] font-[var(--font-display)] text-[clamp(2.2rem,5vw,4.2rem)] font-light leading-[1.1] text-white">
            {title}
          </h1>
          <p className="mt-[var(--space-md)] max-w-2xl text-[clamp(0.875rem,1.5vw,1rem)] leading-[1.75] text-[rgba(255,255,255,0.65)]">
            {description}
          </p>
        ...
        {aside ? (
          <div className="rounded-[var(--radius)] border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.05)] p-[var(--space-lg)] text-white backdrop-blur-[12px]">{aside}</div>
        ) : null}
      </div>
    </section>
  );
