  ...
  return (
    ...
    >
      ...
      <div className="page-section relative">
        <Reveal>
          <div className="rounded-[2.25rem] border border-[#cfe8f6] bg-white/72 p-6 shadow-[0_24px_70px_rgba(114,160,193,0.1)] backdrop-blur-xl md:p-8 lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(460px,0.92fr)] lg:items-end lg:gap-10">
            <div>
              <p className="page-eyebrow text-[#72a0c1]">{c.eyebrow}</p>
              <h2
                id="program-title"
                className="mt-4 max-w-4xl font-[var(--font-display)] text-[clamp(2.8rem,5.6vw,5.8rem)] leading-[0.9] tracking-[-0.065em] text-[#10182a]"
              >
                {c.title}
              </h2>
            ...
            <div className="mt-8 lg:mt-0">
              <div className="mb-5 flex flex-wrap gap-x-6 gap-y-3 text-sm text-[#10182a]/70">
