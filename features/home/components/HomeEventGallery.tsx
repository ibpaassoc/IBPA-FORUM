    ...
    <EditorialMasonryGallery
      ...
      items={[
        ...
        },
        {
          ...
          eyebrow: "Judging",
          text: "Live event coverage makes the award experience feel grounded and editorial.",
        ...
        },
        {
          ...
          title: "Recap scenes",
          eyebrow: "Highlights",
          text: "A dynamic photo that carries the momentum of the full award experience.",
