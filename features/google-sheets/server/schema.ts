...
export const TICKETS_SHEET: SheetDefinition = {
  ...
  columns: [
    ...
    { header: "Gala Dinner", width: 115, wrap: "CLIP" },
    { header: "Стоимость", width: 110, wrap: "CLIP" },
  ...
  conditionalRules: [
    ...
    { columnIndex: 6, equals: "Yes", color: COLORS.green, columnOnly: true },
    { columnIndex: 6, equals: "No", color: COLORS.gray, columnOnly: true },
