...
export function ticketConfirmationTemplate({
  ...
  const blocks = [
    ...
    `<div style="text-align:center;margin:28px 0;"><img src="${qrDataUrl}" alt="Your ticket QR code" width="220" height="220" style="border-radius:12px;border:1px solid rgba(3,2,19,0.1);padding:8px;background:#fff;" /></div>`,
