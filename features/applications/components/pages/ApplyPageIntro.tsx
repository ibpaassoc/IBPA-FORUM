...
export default function ApplyPageIntro() {
  ...
  const copy = {
    en: {
      ...
      steps: [
        { title: "Choose category", text: "Select your category and nomination before uploading materials." },
        { title: "Prepare portfolio", text: "Upload category-relevant media and supporting documents." },
        { title: "Review details", text: "Confirm all fields and files before final submission." },
        { title: "Complete fee", text: "Finalize participation through secure Stripe checkout." },
      ],
    },
    ru: {
      ...
      steps: [
        { title: "Выберите категорию", text: "Выберите категорию и номинацию до загрузки материалов." },
        { title: "Подготовьте портфолио", text: "Загрузите релевантные медиафайлы и подтверждающие документы." },
        { title: "Проверьте детали", text: "Проверьте все поля и файлы перед финальной отправкой." },
        { title: "Оплатите взнос", text: "Завершите участие через защищённый Stripe checkout." },
      ],
    },
    ua: {
      ...
      steps: [
        { title: "Оберіть категорію", text: "Оберіть категорію та номінацію перед завантаженням матеріалів." },
        { title: "Підготуйте портфоліо", text: "Завантажте релевантні медіафайли та підтвердні документи." },
        { title: "Перевірте деталі", text: "Перевірте всі поля й файли перед фінальним надсиланням." },
        { title: "Сплатіть внесок", text: "Завершіть участь через захищений Stripe checkout." },
      ],
    },
  }[language];
