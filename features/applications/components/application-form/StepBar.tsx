...
export default function StepBar({
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4">
      <div className="overflow-x-auto no-scrollbar rounded-[40px] border border-[var(--color-blue)]/15 bg-white/75 px-4 py-3 shadow-[0_18px_60px_rgba(42,66,82,0.08)] backdrop-blur-2xl sm:px-6 sm:py-4">
            ...
            return (
              <div key={step.id} className="flex items-center">
                <button
                  ...
                  className={`group flex min-w-[72px] flex-col items-center gap-1.5 rounded-2xl px-2 py-1.5 transition duration-300 sm:min-w-[86px] ${
                    clickable
                ...
                >
                  <span
                    className={`flex h-9 w-9 items-center justify-center rounded-full border transition-all duration-300 sm:h-10 sm:w-10 ${
                        ...
                        : active
                          ? "scale-110 border-[var(--color-blue)] bg-white text-[var(--color-ink)] shadow-[0_10px_28px_rgba(122,152,175,0.18)]"
                          : unlocked
