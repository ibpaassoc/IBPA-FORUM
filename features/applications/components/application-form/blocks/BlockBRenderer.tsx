...
export default function BlockBRenderer({
  ...
  const emptyText = {
    en: "Choose a category in Block A to unlock the category-specific nomination requirements in Block B.",
    ru: "Выберите категорию в блоке A, чтобы открыть требования по выбранной категории и номинации в блоке B.",
    ua: "Оберіть категорію у блоці A, щоб відкрити вимоги за вибраною категорією та номінацією у блоці B.",
  }[language];
