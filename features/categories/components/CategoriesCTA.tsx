...
export default function CategoriesCTA() {
  ...
  return (
    <section className="relative min-h-[720px] overflow-hidden bg-white md:min-h-[86vh]">
      ...
      <div className="relative z-10 flex min-h-[720px] items-center justify-center px-[var(--page-gutter)] py-20 md:min-h-[86vh]">
        <div className="w-full max-w-6xl">
          <div className="relative overflow-hidden rounded-[2.4rem] border border-white/55 bg-[linear-gradient(135deg,rgba(255,255,255,0.62),rgba(255,255,255,0.24))] px-5 py-10 text-center shadow-[0_44px_130px_rgba(0,0,0,0.28)] backdrop-blur-[30px] sm:px-8 sm:py-12 md:rounded-[3rem] lg:px-12 lg:py-14">
            ...
            <div className="pointer-events-none absolute left-1/2 top-0 h-64 w-64 -translate-x-1/2 rounded-full bg-white/16 blur-3xl" />
