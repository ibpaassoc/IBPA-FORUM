    ...
    <section className="section-rhythm-loose bg-[var(--surface-tint)]">
      <div className="page-section">
        ...
        <div className="relative mt-[var(--space-xl)]">
          <span
            aria-hidden
            className="pointer-events-none absolute left-[16.66%] right-[16.66%] top-[7.1rem] hidden h-px bg-[var(--color-blue-soft)] lg:block"
          />
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            {steps.map((step, index) => {
              ...
              return (
                <article
                  key={step.title}
                  className="premium-glass relative rounded-[32px] p-6 transition-transform duration-300 hover:-translate-y-1"
                >
                  <div className="flex items-start gap-4">
                    <div className="relative flex shrink-0 flex-col items-center">
                      <span className="flex h-11 w-11 items-center justify-center rounded-full border border-[var(--color-blue-soft)] bg-[var(--color-blue-wash)] text-[var(--color-ink)]">
