...
export default function JuryTimeline() {
  ...
  return (
    <section className="relative overflow-hidden bg-white py-[clamp(4.5rem,9vw,8rem)]">
      <div
        aria-hidden
        className="pointer-events-none absolute left-[-14%] top-[-22%] h-[34rem] w-[34rem] rounded-full "
      />
      <div
        aria-hidden
        className="pointer-events-none absolute bottom-[-30%] right-[-12%] h-[38rem] w-[38rem] rounded-full"
      />
