...
export default function JuryApplicationForm() {
  ...
  const copy = {
    en: {
      ...
      profilePhoto: "Your Photo for Jury Profile",
    ...
    ru: {
      ...
      profilePhoto: "Ваше фото для профиля жюри",
      profilePhotoHint: "Загрузите одно ваше профессиональное фото JPG или PNG.",
    ...
    ua: {
      ...
      profilePhoto: "Ваше фото профілю журі",
      profilePhotoHint: "Завантажте одне ваше фото JPG або PNG.",
