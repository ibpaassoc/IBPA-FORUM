        ...
        <div className="rounded-[22px] border border-[rgba(114,160,193,0.34)] bg-[var(--color-blue-wash)]/70 p-4">
          ...
          <form action={requestAdditionalInfoAction} className="mt-3 flex flex-col gap-2">
            ...
            <div className="flex gap-2">
              <button
                type="submit"
                className="inline-flex min-h-9 items-center gap-1.5 rounded-[18px] border border-[var(--color-blue)] bg-[var(--color-blue)] px-3.5 py-2 text-xs font-semibold text-white transition hover:bg-[var(--color-hover-accent)]"
              >
                <Send size={13} />
                Send Request
              </button>
